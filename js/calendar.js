document.addEventListener('DOMContentLoaded', function() {
                ...
                var calendar = new FullCalendar.Calendar(calendarEl, {
                    ...
                    dateClick: function(info) {
                        ...
                        if (!info.allDay) {
                            ...
                            window.location.href = '/gandaal/event.php?ajoutEvent&type=' + formattedDate + '&heured=' + formattedTime;
                        }
                    },
    ...
    // }
        ...
        // xmlhttp.open('get', 'http://localhost/gandaal/calendar_data.php?groupe&dated=' + formattedDate + '&heured=' + formattedTime, true)
