					...
					<tbody><?php
						...
						foreach ($prodeleve as $formation) {?>						
							...
							<tr>
								...
								<td><?=ucfirst(strtolower($formation->prenomel)).' '.strtoupper($formation->nomel);?><input class="form-control" type="hidden" name="matr" value="<?=$formation->matricule;?>"/></td>
									...
									<td>
										<div style="display: flex;">
											<div style="margin-left: 50px;">
												...
												<input class="form-check-input" type="hidden" name="matr" value="<?=$formation->matricule;?>"/>

												<input  class="form-check-input" type="checkbox" name="appel" value="abs" onchange="this.form.submit()" />
											</div>
