...
<div class="container-fluid">
    <div class="row" style="overflow:auto;"><?php
        ...
        if (isset($_GET['annuler_paie'])) {
            ...
            $numdec_paie_banque="paiens".$numdec_paie;
            $DB->delete("DELETE FROM payenseignant WHERE id = '{$id_paie}'  ");
            ...
            <thead>
                                ...
                                <form action="etatsalaire.php" method="POST">
                                    ...
                                    <tr>
                                        ...
                                        if ($formation->salaire==0) {?>
                                            ...
                                            <td class="text-end"><?=number_format($formation->heurep*$formation->thoraire,0,',',' ');?></td>
                                        ...
                                        <td class="text-center"><?=$formation->heurep;?>h</td>

                                        <td class="text-end"><?=number_format($formation->thoraire,0,',',' ');?></td>
                                        ...
                                        if (!empty($formation->etat)) {?>
                                            ...
                                            <td>
                                                ...
                                                <!-- <input type="submit" name="annul" value="Annulé"> -->
                                            </td><?php
                                        }else{?>
                                            ...
                                            <td>
                                                <input type="hidden" name="id" value="<?=$formation->id;?>">
                                                <!-- <button class="btn btn-primary" type="submit" name="paye">Payé</button> --><?php 
                ...
                <tfoot>
                    <tr>
                        ...
                        <th class="text-end"><?=number_format($totsalaireb,0,',',' ');?></th>
