<?php
    ...
    if (isset($_GET['nomel']) or isset($_POST['justabs']) or isset($_GET['absmatri'])) {
        $_SESSION['annee']=' ';
        $dateselect=' ';
    }

    if (isset($_GET['listeabs']) or isset($_GET['supidabs'])) {
        $_SESSION['annee']=' ';
        $dateselect=' ce jour ';
    }
    ...
    <div class="col" style="display: flex; margin-top: -20px;">
        ...
        <form id='formulaire' method="POST" action="listeabsence.php" name="termc" style="height: 30px;"> 
        ...
        <form id='formulaire' method="POST" action="listeabsence.php" name="termc" style="margin-left: -20px; height: 30px;"> 
        ...
        <form id='form' method="POST" action="listeabsence.php" name="termc" style="margin-left: -20px; height: 30px;"> 
