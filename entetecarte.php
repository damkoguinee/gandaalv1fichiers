...
<div style="box-shadow: 3px 0px 20px rgba(1, 255, 255, 0.9); border-bottom: 4px solid blue; width: 100%; text-align: center; font-size: 14px; font-family: georgia; font-weight: bold; margin-top: 1px; background-color: white; color:red;"><div style="margin-left: 35px;">CARTE DE RETRAIT </div>
<div style="margin-left: 35px; color: black; font-size: 11px;">Année-Scolaire <?=($_SESSION['promo']-1).'-'.$_SESSION['promo'];?></div></div>
