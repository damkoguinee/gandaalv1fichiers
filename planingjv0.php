		...
		<div class="row"><?php
			...
			<div class="col-sm-12 col-md-10">
				...
				<div class="d-flex">
					...
					<form class="form" action="planingjv0.php" method="POST">
															...
															foreach ($eventsForDay as $keye=> $event) {
																...
																if ($debut==$values) {
																	...
																	if ($products['niveau']>3){ //Pour permettre la modification des evenements?>
																		...
																		<a class="lienemp" href="planingjv0.php?id=<?=$event->id;?>&codens=<?=$event->codensp;?>&appelj=<?=$appelj;?>&nheure=<?=$deltaval;?>&hdebut=<?=$debut;?>&matn=<?=$event->codem;?>&semestre=<?=$semcourant;?>&classe=<?=$event->nomgrp;?>">
