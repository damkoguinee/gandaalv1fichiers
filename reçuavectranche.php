...
// Afficher les eleves d'un niveau
  ...
  if (isset($_GET['numfac'])) {
    ...
    <table class="border" style=" margin: auto; margin-top: 30px;">
      ...
      <thead>
        <tr>
          <th colspan="4" style="border: 0px; border-right: 1px; text-align: left;">NB: Aucun remboursement ou transfert n'est possible après paiement.</th>

          <th colspan="3">N° de Compte Ecobank</th>
        </tr>

        <tr>
          <th colspan="4" style="border: 0px; border-bottom: 1px; border-right: 1px; text-align: left;">Le paiement de toute scolarité entamée est entièrement dû.</th>

          <th colspan="3"><?=$etab['cbanque'];?></th>
        </tr>

        <tr>
          <th colspan="7" style="border-bottom: 0px; text-align: center;">Réçu de Payement des frais de scolarité <?php if (sizeof($products)==1) {?> de la <?=$_GET['tranche'].$fraisinscript;}?></th>
        </tr>

        <tr>
          <th colspan="2" height="10" style="border-right: 0px; font-size: 12px;">Année-Scolaire: <?=($_SESSION['promo']-1).'-'.$_SESSION['promo'];?></th>

          <th style="border-right: 0px;">Date: <?=$_GET['date'];?></th>
          <th style="border-right: 0px;">N° Réçu: <?=$_GET['numfac'];?></th>
          <th colspan="3">Type de Payement: <?=$_GET['type'];?></th>
        </tr>
      ...
      <tbody><?php
          ...
          foreach ($products as $product){
            ...
            <tr>
              ...
              <td style="text-align: right;"><?=number_format($restetranche,0,',',' '); ?></td>
...
if (isset($_GET['paytotpers'])) {
  ...
  if (isset($_GET['payepersfact'])) {
    ...
    <table style="margin:0px; font-size: 12px;color: black; background: white;" >
