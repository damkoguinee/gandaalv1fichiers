<div class="col" style="margin-bottom: 30px;"><?php
    ...
    if (isset($_GET['compta']) or isset($_GET['sscol'])) {
        $_SESSION['annee']=' ';
        $dateselect=' ';
    }
    ...
    <div class="col" style="display: flex;">
        ...
        <form id='formulaire' method="POST" action="comptabilite.php" name="termc" style="height: 30px;"> 
        ...
        <form id='formulaire' method="POST" action="comptabilite.php" name="termc" style="margin-left: -20px; height: 30px;"> 
        ...
        <form id='form' method="POST" action="comptabilite.php" name="termc" style="margin-left: -20px; height: 30px;"> 
