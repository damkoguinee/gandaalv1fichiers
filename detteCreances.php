      ...
      <div class="col-sm-12 col-md-10" style="overflow: auto;"><?php 
        ...
        if (isset($_POST["valid"])) {
          ...
          if (empty($_POST["client"]) or empty($_POST["montant"]) or empty($_POST['devise'])) {?>
            ...
            header("Location: detteCreances.php?ajout");
            ...
            if ($cat=='dette') {               
              ...
              $DB->insert('INSERT INTO dettesCreances (numcmd, nom_client, montant, taux, devise, numcheque, banquecheque, categorie, motif, typep, comptedep, personnel, dateop, promo) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)', array('dette'.$max, $client, $montant, $taux, $devise, $numcheque, $banquecheque, $cat, $motif, $payement, $compte, $_SESSION['idpseudo'], $dateop, $_SESSION['promo']));            

              $DB->insert('INSERT INTO banque (id_banque, montant, libelles, numero, devise, taux, typep, personnel, numeropaie, banqcheque, date_versement, promob) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)', array($compte, $montant, "dette(".$motif.')', 'dette'.$max, $devise, $taux, $payement, $_SESSION['idpseudo'], $numcheque, $banquecheque, $dateop, $_SESSION['promo']));              
        ...
        if(isset($_GET["categ"])){?>
          ...
          <form id="formulaire" method="POST" action="detteCreances.php?ajout" >
        ...
        if (isset($_GET['ajout']) or isset($_GET['searchclientvers']) or isset($_GET["categ"])) {
          ...
          <form id="formulaire" class="form" method="POST" action="detteCreances.php">
              <ol>          
                <li><label>Collaborateur*</label>
                  ...
                  <a href="detteCreances.php?categ">Ajouter un collaborateur</a>
                </li>
        ...
        if (isset($_POST["validpaie"])) {
            ...
            if (empty($_POST["client"]) or empty($_POST["montant"]) or empty($_POST['devise'])) {?>
              ...
              <div class="alert alert-danger">Les Champs sont vides</div><?php
                ...
                $DB->insert('INSERT INTO dettesCreances (numcmd, nom_client, montant, taux, devise, numcheque, banquecheque, categorie, motif, typep, comptedep, personnel, dateop, promo) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)', array('paiedette'.$max, $client, $montant, $taux, $devise, $numcheque, $banquecheque, $cat, $motif, $payement, $compte, $_SESSION['idpseudo'], $dateop, $_SESSION['promo']));            
  
                $DB->insert('INSERT INTO banque (id_banque, montant, libelles, numero, devise, taux, typep, personnel, numeropaie, banqcheque, date_versement, promob) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)', array($compte, -$montant, "paiedette(".$motif.')', 'paiedette'.$max, $devise, $taux, $payement, $_SESSION['idpseudo'], $numcheque, $banquecheque, $dateop, $_SESSION['promo']));
        ...
        if (isset($_GET['paiedette'])) {?>
            ...
            <form id="formulaire" class="form" method="POST" action="detteCreances.php">
                <ol>          
                  ...
                  <li><label>Compte de retrait*</label>
                    <select  name="compte" required="">
                        <option></option><?php
                        $type='Banque';
                        ...
                        <th colspan="7">
                            <div class="row">
                                <div class="col sm-12 col-md-10">
                                    <?="Liste de vos dettes " .$datenormale ?> <a class="btn btn-info" href="detteCreances.php?ajout">Enregistrer une dette</a>
                                </div>
                                <div class="col sm-12 col-md-2">
                                    <!-- <a style="margin-left: 10px;"href="printversegenerale.php?printdep&date1=<?=$_SESSION['date1'];?>&date2=<?=$_SESSION['date2'];?>&type=<?=$_SESSION['com'];?>&datenormale=<?=$datenormale;?>" target="_blank"><img  style="height: 20px; width: 20px;" src="css/img/pdf.jpg"></a><a style="margin-left: 10px;"href="exportdetteCreances.php?dec" target="_blank"><img  style="height: 20px; width: 20px;" src="css/img/excel.jpg"></a> -->
                                </div>
                            </div>
                        </th>          
                    </tr>
                ...
                <tbody><?php
                    ...
                    foreach ($panier->listeCollaborateur() as $keyd => $valuec) {
                        ...
                        <tr>
                            ...
                            <td><a class="btn btn-primary" href="detteCreances.php?consulter=<?=$valuec->id;?>">Consulter</a></td>          
                            <td><a onClick="alerteV()" class="btn btn-success" href="detteCreances.php?paiedette=<?=$valuec->id;?>&reste=<?=$restegnf;?>&cat=<?="paiementdette";?>">Payé</a></td>          
                        </tr><?php 
                    }?>
                        ...
                        <tr>
                            ...
                            <td><?php 
                                if ($_SESSION['type']=='admin' or $_SESSION['type']=='comptable') {?>
                                    <a onClick="alerteS()" class="btn btn-danger" href="detteCreances.php?deletedette=<?=$value->numcmd;?>">Annuler</a><?php 
                                }?>
                            </td>          
                        </tr><?php 
                    }?>
