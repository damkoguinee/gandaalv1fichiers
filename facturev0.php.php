...
<page backtop="5mm" backleft="3mm" backright="1mm" backbottom="5mm"><?php
  ...
  if (isset($_GET['numfac'])) {
    ...
    <table class="border" style=" margin: auto; margin-top: 30px;">
      ...
      <thead>
        <tr>
          <th colspan="4" style="border: 0px; border-right: 1px; text-align: left;">NB: Aucun remboursement ou transfert n'est possible après paiement.</th><?php 
          foreach($panier->nomBanqueTicket() as $product){
            ...
            <th colspan="<?=$cols;?>"><?=ucwords($product->nomb);?> N°</th><?php
          }?>
        </tr>
        ...
        <tr>
          ...
          foreach($panier->nomBanqueTicket() as $product){
            ...
            <th colspan="<?=$cols;?>"><?=ucwords($product->numero);?></th><?php
          }?>
        </tr>
